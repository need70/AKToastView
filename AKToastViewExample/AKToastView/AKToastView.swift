...
class AKToastView: UIView {
    ...
    public class func show(_ text: String?) {
        ...
        let view = AKToastView.loadFromNib()
    ...
    public class func hide(completion: finishedLoadBlock?) {
        
        if let view = kWindowView.viewWithTag(kToastViewTag) as? AKToastView {
    ...
    //hide without chekmark
    
    public class func errHide(completion: finishedLoadBlock?) {
